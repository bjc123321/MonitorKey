...
QT_MOC_LITERAL(2, 32, 24), // "com.monitorkey.interface"
QT_MOC_LITERAL(3, 57, 11), // "exitService"
QT_MOC_LITERAL(4, 69, 0), // ""
QT_MOC_LITERAL(5, 70, 11) // "monitor_key"

    },
    "SysdbusRegister\0D-Bus Interface\0"
    "com.monitorkey.interface\0exitService\0"
    "\0monitor_key"
};
...
static const uint qt_meta_data_SysdbusRegister[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       3,    0,   26,    4, 0x4a /* Public | isScriptable */,
       5,    0,   27,    4, 0x4a /* Public | isScriptable */,
...
void SysdbusRegister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->exitService();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: { QString _r = _t->monitor_key();
