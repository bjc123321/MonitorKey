#ifndef MONIIRKEYEVENT_H
#define MONIIRKEYEVENT_H
...
{
   Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.ukui.monitor.line.control")

public:
    MonitorKeyEvent(int argc, char *argv[]);
    ~MonitorKeyEvent();
    ...
    void sendkey(int msec,unsigned long curTime ,unsigned long privTime,int key_count);
